...
class inode_state 
{
   ...
   public:
      ...
      static map<string,inode_ptr> directories;
      static map<string,string> fileContents;   //<file name, file contents>
      static map<string,inode_ptr> fileNames;
};
...
class directory: public base_file 
{
   ...
   public:
      ...
      map<string,inode_ptr>& getDirents(){return dirents;}
};
