...
//Create a vector of objects. An object contains
//a pointer to a shape, a vertex, and an rgb color.
vector<object> window::objects;
//Set selected_obj = 0 (The selected shape).
size_t window::selected_obj = 0;
//Declare a mouse object, which contains state and position.
mouse window::mus;

//Object constructor initializes values.
...
//Draw the shape, given a center coordinate and a color.
void object::draw() 
{
...
//Set the state value based on mouse button activity.
...
//Check if left/middle/right button has been pressed.
//Check if the mouse has entered the window. If so, set the
//font and color.
void mouse::draw() 
{
   ...
   if (entered == GLUT_ENTERED) 
   {
      ...
      //Specify the raster positions for pixel operations.
      glRasterPos2i (10, 10);
...
0...9    Set the selection to objects 0 through 9.
)";
}
